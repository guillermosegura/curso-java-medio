...
import com.axity.to.Person;

class AssertionsDemo
{

  private final ArithmeticService arithmeticService = new ArithmeticServiceImpl();
  ...
  void standardAssertions()
  {
    ...
    assertEquals( 4, arithmeticService.multiply( 2, 2 ), "The optional failure message is now the last parameter" );
